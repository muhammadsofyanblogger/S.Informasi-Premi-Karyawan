    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>SELAMAT DATANG DI SI PREMI KARYAWAN PT BAKRIE SUMATERA PLANTATIONS</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Informasi Premi Karyawan</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">Nama Karyawan</th><th>Jumlah Janjang</th><th>Tanggal Panen</th><th>Mandor</th><th></th>
                            </tr>
                        </thead>
                        <tbody>
