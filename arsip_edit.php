        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Form Update Data Karyawan Dan Mandor</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="noRak" class="col-sm-3 control-label">noRak</label>
                            <div class="col-sm-9">
						...
						<div class="form-group">
                            <label for="ruang_arsip_" class="col-sm-3 control-label">Alamat</label>
                            <div class="col-sm-9">
                                <input type="text" name="ruang_arsip" value="<?=$data['ruang_arsip']?>"class="form-control" id="inputEmail3" placeholder="Alamat">
                            </div>
                        </div>
						<div class="form-group">
							...
							<div class="form-group">
                            <label for="noPerkara" class="col-sm-3 control-label">Id</label>
                            <div class="col-sm-9">
